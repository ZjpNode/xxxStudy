...
//使用es3ify-webpack-plugin兼容IE8（代码中或者使用了保留字，比如default；实现：如用字符串“default”替代保留字default）
...
module.exports = {
    ...
    entry: {
        test: "./src/test.js",
        //vendor: "/vendor.js"
        vendor: ['es5-shim', 'es5-shim/es5-sham', 'console-polyfill','es6-promise','jquery']  //将公用库单独提取打包
    },
    externals: {
        jquery: "$"
    },
        ...
        loaders: [
            ...
            },
            {
                ...
                loaders: [
                    ...
                    'url-loader?limit=10240&name=imgs/[hash:8].[name].[ext]',
                    //图片优化
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: path.join(__dirname, '/src/test2.html'),
