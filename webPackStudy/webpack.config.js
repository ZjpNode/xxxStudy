...
module.exports = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: path.join(__dirname, './src/base/index.html'),
            filename: './html/index.html',  //其输出的路径是相对于output.path路径而言的
            //minify: { removeAttributeQuotes: true },
        }),
        /*new HtmlWebpackPlugin({
            template: path.join(__dirname, './src/business/pageB/main.html'),
            filename: './business/pageB/main.html',  //其输出的路径是相对于output.path路径而言的
            chunks: []
        }),*/
