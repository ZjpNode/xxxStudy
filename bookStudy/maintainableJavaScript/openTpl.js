...
(function ($, window, document) {
  ...
  function openNewWind(cardNum) {
    ...
    $('#tpl_win').window({
      ...
      onLoad: function () {
        document.getElementById('accessIframe').src =
          accessWinUrl + '?orgCode=' + orgCode + '&token=' + token + '&card_num=' + cardNum;
      }
    });
    $('#tpl_win').show();
    $('#tpl_win').window('open');
